...
export default function Chat({ ingredients }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const userMessage = `Please tell me the amount of PFC in 鶏胸肉 納豆 豆腐 . The value for the PFC must be float value and the unit of them is gram. This is the ideal structure. {"PFC": ${JSON.stringify(totalPFC)}}`;
...
//         const userMessage = `Please tell me the amount of PFC in ${ingredients}. The value for the PFC must be float value and the unit of them is gram. This is the ideal structure. {"PFC": ${JSON.stringify(totalPFC)}}`;
...
//                         {message.sender === "ai" && (
//                             <>
//                                 <p>タンパク質 {message.PFC.totalProtein} g</p>
